...
/// <summary>
/// Notification-area icon with quick access to the windows and Exit. Also provides the app icon
/// (drawn at runtime, so no binary .ico needs to live in the repository).
/// </summary>
public sealed class TrayIcon : IDisposable
{
    ...
    {
        BitmapSource source = Imaging.CreateBitmapSourceFromHIcon(_icon.Handle, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
        source.Freeze();
        return source;
    }
    ...
    /// <summary>Draws a small swipe-arrow icon.</summary>
